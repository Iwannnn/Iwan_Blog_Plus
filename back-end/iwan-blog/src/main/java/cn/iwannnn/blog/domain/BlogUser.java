...
public class BlogUser extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("userId", getUserId())
				.append("account", getAccount()).append("nickname", getNickname()).append("password", getPassword())
				.append("phone", getPhone()).append("email", getEmail()).append("avatar", getAvatar())
				.append("birthday", getBirthday()).append("introduction", getIntroduction())
