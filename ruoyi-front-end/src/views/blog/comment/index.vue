<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="被评论用户名account优先nickname" prop="becommentUserName">
        <el-input
          v-model="queryParams.becommentUserName"
          placeholder="请输入被评论用户名account优先nickname"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="评论用户名accout优先nickname" prop="commentUserName">
        <el-input
          v-model="queryParams.commentUserName"
          placeholder="请输入评论用户名accout优先nickname"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="被评论用户id" align="center" prop="becommentUserId" />
      <el-table-column label="被评论用户名account优先nickname" align="center" prop="becommentUserName" />
      <el-table-column label="评论用户id" align="center" prop="commentUserId" />
      <el-table-column label="评论用户名accout优先nickname" align="center" prop="commentUserName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="博客id" prop="blogId">
          <el-input v-model="form.blogId" placeholder="请输入博客id" />
        </el-form-item>
        <el-form-item label="父级评论" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父级评论" />
        </el-form-item>
        <el-form-item label="被评论用户id" prop="becommentUserId">
          <el-input v-model="form.becommentUserId" placeholder="请输入被评论用户id" />
        </el-form-item>
        <el-form-item label="被评论用户名account优先nickname" prop="becommentUserName">
          <el-input v-model="form.becommentUserName" placeholder="请输入被评论用户名account优先nickname" />
        </el-form-item>
        <el-form-item label="评论用户id" prop="commentUserId">
          <el-input v-model="form.commentUserId" placeholder="请输入评论用户id" />
        </el-form-item>
        <el-form-item label="评论用户名accout优先nickname" prop="commentUserName">
          <el-input v-model="form.commentUserName" placeholder="请输入评论用户名accout优先nickname" />
        </el-form-item>
        <el-form-item label="评论点赞数" prop="likes">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除文章评论编号为"' + commentIds + '"的数据项?', "警告", {
