<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="likeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否取消了点赞" align="center" prop="isDelete" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否取消了点赞" prop="isDelete">
          <el-input v-model="form.isDelete" placeholder="请输入是否取消了点赞" />
        </el-form-item>
        <el-form-item label="评论id" prop="commentId">
...
<script>
import { listLike, getLike, delLike, addLike, updateLike, exportLike } from "@/api/blog/like";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户点赞管理编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有用户点赞管理数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
