...
public class BlogUserController extends BaseController
{
    ...
    @Log(title = "博客系统用户", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "博客系统用户", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "博客系统用户", businessType = BusinessType.DELETE)
