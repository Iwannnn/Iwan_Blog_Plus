 ...
 */
@RestController
@RequestMapping("/blog/article_tag")
public class BlogArticleTagController extends BaseController
{
     ...
     * 查询文章标签列表
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:list')")
    @GetMapping("/list")
     ...
     * 导出文章标签列表
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:export')")
     ...
     * 获取文章标签详细信息
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增文章标签
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:add')")
     ...
     * 修改文章标签
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:edit')")
     ...
     * 删除文章标签
     */
    @PreAuthorize("@ss.hasPermi('blog:article_tag:remove')")
