...
public class BlogComment extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("commentId", getCommentId())
				...
				.append("becommentUserId", getBecommentUserId()).append("becommentUserName", getBecommentUserName())
				.append("commentUserId", getCommentUserId()).append("commentUserName", getCommentUserName())
